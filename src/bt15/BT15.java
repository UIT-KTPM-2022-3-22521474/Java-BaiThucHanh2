...
public class BT15 extends javax.swing.JFrame {
    private FirePanel firePanel;
    
    public BT15(int fireCount, Image[] fireSprites) {
    ...
    public static void main(String args[]) {
        ...
        for (int i = 0; i < 25; i++) {
            String fileName = "src/bt15/img/fire" + (i+1) + ".png";
        ...
        try {
            ...
            if (fireCount < 1 || fireCount > 10) {
                JOptionPane.showMessageDialog(null, "Số lượng ngọn lửa phải từ 1 đến 10. Chương trình sẽ đặt mặc định là 1.");
                fireCount = 1;
            }
        ...
        BT15 fireDisplay = new BT15(fireCount, fireSprites);
